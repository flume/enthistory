...
func init() {
	...
	characterhistoryDescCreatedAt := characterhistoryFields[8].Descriptor()
	...
	characterhistoryDescUpdatedAt := characterhistoryFields[9].Descriptor()
	...
	friendshiphistoryDescCreatedAt := friendshiphistoryFields[7].Descriptor()
	...
	friendshiphistoryDescUpdatedAt := friendshiphistoryFields[8].Descriptor()
	...
	residencehistoryDescCreatedAt := residencehistoryFields[6].Descriptor()
	...
	residencehistoryDescUpdatedAt := residencehistoryFields[7].Descriptor()
