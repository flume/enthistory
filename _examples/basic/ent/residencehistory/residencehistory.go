...
const (
	// Label holds the string label denoting the residencehistory type in the database.
	Label = "residence_history"
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("residencehistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the ResidenceHistory queries.
