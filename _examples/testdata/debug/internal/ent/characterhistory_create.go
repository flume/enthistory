...
func (chc *CharacterHistoryCreate) SetUpdatedBy(u uuid.UUID) *CharacterHistoryCreate {
	chc.mutation.SetUpdatedBy(u)
	return chc
}

// SetNillableUpdatedBy sets the "updated_by" field if the given value is not nil.
func (chc *CharacterHistoryCreate) SetNillableUpdatedBy(u *uuid.UUID) *CharacterHistoryCreate {
	if u != nil {
		chc.SetUpdatedBy(*u)
	}
	return chc
...
func (chc *CharacterHistoryCreate) SetNillableID(u *uuid.UUID) *CharacterHistoryCreate {
	if u != nil {
		chc.SetID(*u)
	}
	return chc
...
func (chc *CharacterHistoryCreate) createSpec() (*CharacterHistory, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(characterhistory.Table, sqlgraph.NewFieldSpec(characterhistory.FieldID, field.TypeUUID))
	)
	...
	if value, ok := chc.mutation.UpdatedBy(); ok {
		_spec.SetField(characterhistory.FieldUpdatedBy, field.TypeUUID, value)
