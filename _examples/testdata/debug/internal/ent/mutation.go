...
func (m *CharacterMutation) SetOther(s string) {
	m.other = &s
}

// Other returns the value of the "other" field in the mutation.
func (m *CharacterMutation) Other() (r string, exists bool) {
	v := m.other
	if v == nil {
		return
	}
...
// OldOther returns the old "other" field's value of the Character entity.
// If the Character object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CharacterMutation) OldOther(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CharacterMutation) ResetOther() {
	m.other = nil
}
...
func (m *CharacterMutation) Fields() []string {
	...
	if m.other != nil {
		fields = append(fields, character.FieldOther)
	}
	if m.age != nil {
...
func withCharacterHistoryID(id uuid.UUID) characterhistoryOption {
...
func (m *CharacterHistoryMutation) SetID(id uuid.UUID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *CharacterHistoryMutation) ID() (id uuid.UUID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *CharacterHistoryMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
func (m *CharacterHistoryMutation) SetUpdatedBy(u uuid.UUID) {
	m.updated_by = &u
}

// UpdatedBy returns the value of the "updated_by" field in the mutation.
func (m *CharacterHistoryMutation) UpdatedBy() (r uuid.UUID, exists bool) {
	v := m.updated_by
	if v == nil {
		return
	}
...
// If the CharacterHistory object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CharacterHistoryMutation) OldUpdatedBy(ctx context.Context) (v *uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// ClearTypedAge clears the value of the "typed_age" field.
func (m *CharacterHistoryMutation) ClearTypedAge() {
	m.typed_age = nil
	m.addtyped_age = nil
	m.clearedFields[characterhistory.FieldTypedAge] = struct{}{}
}

// TypedAgeCleared returns if the "typed_age" field was cleared in this mutation.
func (m *CharacterHistoryMutation) TypedAgeCleared() bool {
	_, ok := m.clearedFields[characterhistory.FieldTypedAge]
	return ok
}
...
func (m *CharacterHistoryMutation) ResetTypedAge() {
	m.typed_age = nil
	m.addtyped_age = nil
	delete(m.clearedFields, characterhistory.FieldTypedAge)
}
...
func (m *CharacterHistoryMutation) ClearedFields() []string {
	...
	if m.FieldCleared(characterhistory.FieldTypedAge) {
		fields = append(fields, characterhistory.FieldTypedAge)
	}
...
func withFriendshipHistoryID(id uuid.UUID) friendshiphistoryOption {
...
func (m *FriendshipHistoryMutation) SetID(id uuid.UUID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *FriendshipHistoryMutation) ID() (id uuid.UUID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *FriendshipHistoryMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
// SetUpdatedBy sets the "updated_by" field.
func (m *FriendshipHistoryMutation) SetUpdatedBy(u uuid.UUID) {
	m.updated_by = &u
}

// UpdatedBy returns the value of the "updated_by" field in the mutation.
func (m *FriendshipHistoryMutation) UpdatedBy() (r uuid.UUID, exists bool) {
	v := m.updated_by
	if v == nil {
		return
	}
...
// If the FriendshipHistory object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FriendshipHistoryMutation) OldUpdatedBy(ctx context.Context) (v *uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedBy is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
