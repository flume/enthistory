...
func (fhc *FriendshipHistoryCreate) SetUpdatedBy(u uuid.UUID) *FriendshipHistoryCreate {
	fhc.mutation.SetUpdatedBy(u)
	return fhc
}

// SetNillableUpdatedBy sets the "updated_by" field if the given value is not nil.
func (fhc *FriendshipHistoryCreate) SetNillableUpdatedBy(u *uuid.UUID) *FriendshipHistoryCreate {
	if u != nil {
		fhc.SetUpdatedBy(*u)
	}
	return fhc
...
func (fhc *FriendshipHistoryCreate) SetID(u uuid.UUID) *FriendshipHistoryCreate {
	fhc.mutation.SetID(u)
	return fhc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (fhc *FriendshipHistoryCreate) SetNillableID(u *uuid.UUID) *FriendshipHistoryCreate {
	if u != nil {
		fhc.SetID(*u)
	}
	return fhc
...
func (fhc *FriendshipHistoryCreate) createSpec() (*FriendshipHistory, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(friendshiphistory.Table, sqlgraph.NewFieldSpec(friendshiphistory.FieldID, field.TypeUUID))
	)
	...
	if value, ok := fhc.mutation.UpdatedBy(); ok {
		_spec.SetField(friendshiphistory.FieldUpdatedBy, field.TypeUUID, value)
