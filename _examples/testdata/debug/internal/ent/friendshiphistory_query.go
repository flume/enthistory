...
func (fhq *FriendshipHistoryQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (fhq *FriendshipHistoryQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (fhq *FriendshipHistoryQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (fhq *FriendshipHistoryQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (fhq *FriendshipHistoryQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (fhq *FriendshipHistoryQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := fhq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (fhq *FriendshipHistoryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(friendshiphistory.Table, friendshiphistory.Columns, sqlgraph.NewFieldSpec(friendshiphistory.FieldID, field.TypeUUID))
	_spec.From = fhq.sql
