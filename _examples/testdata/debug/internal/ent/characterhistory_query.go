...
func (chq *CharacterHistoryQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (chq *CharacterHistoryQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (chq *CharacterHistoryQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (chq *CharacterHistoryQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := chq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (chq *CharacterHistoryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(characterhistory.Table, characterhistory.Columns, sqlgraph.NewFieldSpec(characterhistory.FieldID, field.TypeUUID))
	_spec.From = chq.sql
