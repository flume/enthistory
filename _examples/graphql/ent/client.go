...
func (c *Client) WithHistory() {
	if !c.historyActivated {
		...
		// TestSkip hooks
		c.TestSkip.Use(enthistory.HistoryTriggerInsert[*TestSkipMutation]())
		c.TestSkip.Use(enthistory.HistoryTriggerUpdate[*TestSkipMutation]())
		c.TestSkip.Use(enthistory.HistoryTriggerDelete[*TestSkipMutation]())

		// Todo hooks
		c.Todo.Use(enthistory.HistoryTriggerInsert[*TodoMutation]())
		c.Todo.Use(enthistory.HistoryTriggerUpdate[*TodoMutation]())
		c.Todo.Use(enthistory.HistoryTriggerDelete[*TodoMutation]())
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.TestExclude, c.TestSkip, c.TestSkipHistory, c.Todo, c.TodoHistory, c.User,
		c.UserHistory,
	} {
		n.Use(hooks...)
	}
...
type (
	hooks struct {
		TestExclude, TestSkip, TestSkipHistory, Todo, TodoHistory, User,
