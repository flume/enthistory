...
const (
	// Label holds the string label denoting the testskiphistory type in the database.
	Label = "test_skip_history"
	...
	FieldName = "name"
	// Table holds the table name of the testskiphistory in the database.
	Table = "testskip_history"
)

// Columns holds all SQL columns for testskiphistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldOperation,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("testskiphistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the TestSkipHistory queries.
