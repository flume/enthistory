...
func (tx *Tx) init() {
	tx.TestExclude = NewTestExcludeClient(tx.config)
	tx.TestSkip = NewTestSkipClient(tx.config)
...
// applies a query, for example: TestExclude.QueryXXX(), the query will be executed
