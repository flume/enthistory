...
func (r *queryResolver) UserHistories(ctx context.Context, after *entgql.Cursor[uuid.UUID], first *int, before *entgql.Cursor[uuid.UUID], last *int, where *ent.UserHistoryWhereInput) (*ent.UserHistoryConnection, error) {
	panic(fmt.Errorf("not implemented: UserHistories - userHistories"))
}
