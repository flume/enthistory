...
func (_q *OrganizationQuery) QueryOrganizationStores() *StoreQuery {
...
func (_q *OrganizationQuery) Clone() *OrganizationQuery {
	...
	return &OrganizationQuery{
		...
		withOrganizationStores: _q.withOrganizationStores.Clone(),
...
func (_q *OrganizationQuery) WithOrganizationStores(opts ...func(*StoreQuery)) *OrganizationQuery {
	query := (&StoreClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withOrganizationStores = query
	return _q
}
...
func (_q *OrganizationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Organization, error) {
	...
	if query := _q.withOrganizationStores; query != nil {
		if err := _q.loadOrganizationStores(ctx, query, nodes,
...
func (_q *OrganizationQuery) loadOrganizationStores(ctx context.Context, query *StoreQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *Store)) error {
