...
type OrganizationHistoryFunc func(context.Context, *ent.OrganizationHistoryMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OrganizationHistoryFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OrganizationHistoryMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OrganizationHistoryMutation", m)
}
...
// The StoreHistoryFunc type is an adapter to allow the use of ordinary
// function as StoreHistory mutator.
type StoreHistoryFunc func(context.Context, *ent.StoreHistoryMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f StoreHistoryFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.StoreHistoryMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.StoreHistoryMutation", m)
}
