...
func (c *Client) WithHistory() {
	if !c.historyActivated {
		...
		// Character hooks
		c.Character.Use(enthistory.HistoryTriggerInsert[*CharacterMutation]())
		c.Character.Use(enthistory.HistoryTriggerUpdate[*CharacterMutation]())
		c.Character.Use(enthistory.HistoryTriggerDelete[*CharacterMutation]())

		// Friendship hooks
		c.Friendship.Use(enthistory.HistoryTriggerInsert[*FriendshipMutation]())
		c.Friendship.Use(enthistory.HistoryTriggerUpdate[*FriendshipMutation]())
		c.Friendship.Use(enthistory.HistoryTriggerDelete[*FriendshipMutation]())

		// Residence hooks
		c.Residence.Use(enthistory.HistoryTriggerInsert[*ResidenceMutation]())
		c.Residence.Use(enthistory.HistoryTriggerUpdate[*ResidenceMutation]())
		c.Residence.Use(enthistory.HistoryTriggerDelete[*ResidenceMutation]())
